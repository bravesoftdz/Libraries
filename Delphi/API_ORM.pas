...
type
  ...
  TEntityList<T: class> = class abstract(TObjectList<T>)
  private
    FDBEngine: TDBEngine;
...
var
  ListPointer: ^TLevelList;
  EntityList:  TLevelList;
  //EntityPointer: Pointer;
  //HasLists: Boolean;
begin
  for ListPointer in FLists do
    begin
...
begin
  EntityClass := TEntityAbstractClass(T);
